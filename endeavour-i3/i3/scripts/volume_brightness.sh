...
function show_volume_notif {
    ...
    dunstify -i audio-volume-muted-blocking -t 1000 -u normal "$volume_icon $volume%" -h int:value:$volume -h string:hlcolor:$bar_color
}
...
function show_brightness_notif {
    ...
    dunstify -t 1000 -u normal "$brightness_icon $brightness%" -h int:value:$brightness -h string:hlcolor:$bar_color
}
